...
% The function getCapt computes and returns the captain with zero heading located
%at the origin in the form of a matirx.
% The input parameters captSize sets the size of the captain. The output is a
%matrix in which
